...
public class PaymentApi {
    ...
    private static String mToPUrl = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";

    /*
    * 企业付款到零钱
    * */
    public static String mToPOrder(Map<String, String> params) {
        return HttpKit.post(mToPUrl, PaymentKit.toXml(params));
    }
